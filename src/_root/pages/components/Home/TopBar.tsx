...
function TopBar() {
  ...
  return (
    <div className="h-16 bg-white text-black flex justify-between items-center px-4 border border-slate-200">
      ...
      <img src="/assets/icons/ricefield logo home.svg" alt="Logo" className="h-8 cursor-pointer" onClick={() => navigate('/')}/>
      <img src="/assets/icons/beta version mark.svg" alt="BETA" className='h-5 mb-4 cursor-pointer'onClick={() => navigate('/')}/>
      </div>
